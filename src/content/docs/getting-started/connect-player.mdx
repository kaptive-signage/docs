...
We recommend using a dedicated Kaptive player for commercial deployments, while web players are suitable for testing and small-scale use cases.

The web player can be accessed at [https://player.kaptive.app](https://player.kaptive.app).
