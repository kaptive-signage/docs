...
Pour assembler votre propre Kaptive Player, nous recommandons d'utiliser un kit de développement Compute Module 5 de Raspberry Pi. Le kit comprend tout ce dont vous avez besoin pour commencer :
...
<Steps>
    ...
    3. Flashez l’image Kaptive OS sur le Compute Module à l'aide de [Raspberry Pi Imager](https://www.raspberrypi.com/software/).
        ...
        2. Sélectionnez l'OS : Vous trouverez l'image du Kaptive Player sous `Freemium and paid-for OS` > `Digital Signage OS` > `Kaptive Player`
